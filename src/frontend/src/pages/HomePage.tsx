        ...
        <div style={{ marginTop: '0' }}>
                    ...
                    <div className="govuk-grid-row ">
                        <div className="govuk-grid-column-full govuk-grid-column-two-thirds-from-desktop">
                            ...
                            <div data-module="idsk-search-component" className="idsk-search-component   ">
                                ...
                                <input
                                    className="govuk-input idsk-search-component__input "
            ...
            21.0196C8.81278 21.0196 5.16779 17.4681 5.16779 13.103Z"
                        ...
                        <div className="idsk-intro-block__side-menu govuk-grid-column-full govuk-grid-column-one-third-from-desktop">
                            <h2 className="govuk-heading-s">{t('homePage.favorities')}</h2>
                            <ul className="idsk-intro-block__side-menu__ul">
                                <li className="idsk-intro-block__side-menu__li">
                                    <Link className="govuk-link idsk-intro-block__side-menu__a" to="/datasety" title={t('homePage.registeredDatasets')}>
                                        {t('homePage.registeredDatasets')}
                                    </Link>
                                </li>
                                <li className="idsk-intro-block__side-menu__li">
                                    <Link className="govuk-link idsk-intro-block__side-menu__a" to="/lokalne-katalogy" title={t('homePage.localCatalogs')}>
                                        {t('homePage.localCatalogs')}
                                    </Link>
                                </li>
                                <li className="idsk-intro-block__side-menu__li">
                                    <Link className="govuk-link idsk-intro-block__side-menu__a" to="/poskytovatelia" title={t('homePage.publishers')}>
                                        {t('homePage.publishers')}
                                    </Link>
                                </li>
                                <li className="idsk-intro-block__side-menu__li">
                                    <Link className="govuk-link idsk-intro-block__side-menu__a" to="/kvalita-metadat" title={t('homePage.qualityStatistics')}>
                                        {t('homePage.qualityStatistics')}
                                    </Link>
                                </li>
                            </ul>
                        </div>
            ...
            {publishers && publishers.totalCount > 0 ? (
                <>
                    ...
                    <h2 className="govuk-heading-l">{t('homePage.publishersWithMaxDatasets')}</h2>
                    <p className="govuk-body-m">
                        {t('homePage.totalPublishersCount', { val: publishers?.totalCount })}, {t('homePage.listOfAllPublishers')}{' '}
                        <Link className="govuk-link" to="/poskytovatelia">
                            {t('homePage.openDataPublishersPage')}
                        </Link>
                        .
                    </p>
                        ...
                        <div className="govuk-grid-column-full">
                            <div data-module="idsk-crossroad" className="govuk-clearfix">
                                <div className="idsk-crossroad idsk-crossroad-2">
                                    {publishers.items.slice(0, 2).map((p, i) => (
                                        <HomePagePublisher publisher={p} key={i} />
                                    ))}
                                </div>
                                <div className="idsk-crossroad idsk-crossroad-2">
                                    {publishers.items.slice(2, 4).map((p, i) => (
                                        <HomePagePublisher publisher={p} key={i} />
                                    ))}
                                </div>
                            </div>
