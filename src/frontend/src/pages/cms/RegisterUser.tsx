        ...
        <MainContent>
            ...
            <GridRow>
                <GridColumn widthUnits={1} totalUnits={2}>
                    <FormElementGroup label={t('registerPage.fields.firstName')}
            ...
            <GridRow>
                <GridColumn widthUnits={1} totalUnits={2}>
                    <FormElementGroup label={t('registerPage.fields.lastName')}
                                      element={id => <BaseInput id={id} disabled={saving} value={user.user.userName}
                                                                onChange={e => setUser({
                                                                    user: {
                                                                        ...user.user,
            ...
            <GridRow>
                <GridColumn widthUnits={1} totalUnits={2}>
                    <FormElementGroup label={t('registerPage.fields.email')}
                    ...
                    <a href='#' role='button' draggable='false'
                       ...
                       data-module='idsk-button'>
                        ...
                        <span style={{ paddingLeft: '0.75rem' }}>
                            {t('loginPage.socialLogin.eGovernment')}
                        </span>
                    </a>
                </GridColumn>
            </GridRow>
                ...
                <GridColumn widthUnits={1} totalUnits={2}>
                    <a href='#' role='button' draggable='false'
                       ...
                       data-module='idsk-button'>
                        ...
                        <span style={{ paddingLeft: '0.75rem' }}>
                            {t('loginPage.socialLogin.google')}
                        </span>
                    </a>
                </GridColumn>
            </GridRow>
            <GridRow>
                <GridColumn widthUnits={1} totalUnits={2}> <a href='#' role='button' draggable='false'
                                                              className='idsk-button idsk-button--start idsk-button idsk-button--secondary govuk-!-width-full'
                                                              data-module='idsk-button'>
                    <svg xmlns='http://www.w3.org/2000/svg' height='24' viewBox='0 0 24 24' width='24'>
                    ...
                    <span style={{ paddingLeft: '0.75rem' }}>
                            {t('loginPage.socialLogin.microsoft')}
                        </span>
                </a>
                </GridColumn>
            </GridRow>
            ...
            <GridRow>
                <GridColumn widthUnits={1} totalUnits={2}> <a href='#' role='button' draggable='false'
                    ...
                    <span style={{ paddingLeft: '0.75rem' }}>
                            {t('loginPage.socialLogin.facebook')}
                        </span>
                </a>
                </GridColumn>
            </GridRow>
                ...
                <GridColumn widthUnits={1} totalUnits={2}>
                    <a href='#' role='button' draggable='false'
                       ...
                       data-module='idsk-button'>
                        ...
                        <span style={{ paddingLeft: '0.75rem' }}>
                            {t('loginPage.socialLogin.twitter')}
                        </span>
                    </a>
                </GridColumn>
            </GridRow>
            ...
            <GridRow>
                <GridColumn widthUnits={1} totalUnits={4}>
                    <Link to='/odkomunita/login' className='idsk-card-title govuk-link'>
