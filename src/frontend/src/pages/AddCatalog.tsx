...
export default function AddCatalog() {
    ...
    return (
        <>
            <Breadcrumbs
                items={[{ title: t('nkod'), link: '/' }, { title: t('localCatalogList'), link: '/sprava/lokalne-katalogy' }, { title: t('newCatalog') }]}
            />
            <MainContent>
                <div className="nkod-form-page">
                    ...
                    <LocalCatalogForm catalog={catalog} setCatalog={setCatalog} errors={errors} saving={saving} />
