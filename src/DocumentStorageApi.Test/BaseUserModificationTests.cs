...
{
    public class BaseUserModificationTests : IClassFixture<StorageFixture>
    {
        private readonly StorageFixture fixture;

        public BaseUserModificationTests(StorageFixture fixture)
        {
        ...
        public async Task FileShouldNotBeInserted()
        {
            ...
            client.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue(JwtBearerDefaults.AuthenticationScheme, applicationFactory.CreateToken("User"));
